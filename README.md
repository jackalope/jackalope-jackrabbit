...
If you want to integrate jackalope into other PSR-0 compliant code and just use
one classloader, find the mapping in ``vendor/.composer/autoload_namespaces.php``
...
but you can also use the PHPCR API to create workspaces from your program.
